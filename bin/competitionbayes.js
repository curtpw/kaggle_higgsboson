		 	...
		 	async.waterfall([   //time to do things one at a time
			 	...
			 	function(callback) {  //CREATE CLASSIFIERS
					...
					var natural = require('natural'),
  					...
  					javajava_classifier = new natural.BayesClassifier(),
  					php_classifier = new natural.BayesClassifier(),
  					javascript_classifier = new natural.BayesClassifier(),
  					android_classifier = new natural.BayesClassifier(),
  					jquery_classifier = new natural.BayesClassifier(),
  					cplusplus_classifier = new natural.BayesClassifier(),
  					python_classifier = new natural.BayesClassifier(),
  					iphone_classifier = new natural.BayesClassifier(),
  					aspnet_classifier = new natural.BayesClassifier(),
  					mysql_classifier = new natural.BayesClassifier(),
  					html_classifier = new natural.BayesClassifier(),
  					net_classifier = new natural.BayesClassifier(),
  					ios_classifier = new natural.BayesClassifier(),
  					objectivec_classifier = new natural.BayesClassifier(),
  					sql_classifier = new natural.BayesClassifier(),
  					css_classifier = new natural.BayesClassifier(),
  					linux_classifier = new natural.BayesClassifier(),
  					rubyonrails_classifier = new natural.BayesClassifier(),
  					windows_classifier = new natural.BayesClassifier(),
  					c_classifier = new natural.BayesClassifier(),
  					sqlserver_classifier = new natural.BayesClassifier(),
  					ruby_classifier = new natural.BayesClassifier(),
  					wpf_classifier = new natural.BayesClassifier(),
  					xml_classifier = new natural.BayesClassifier(),
  					ajax_classifier = new natural.BayesClassifier(),
  					database_classifier = new natural.BayesClassifier(),
  					windows7_classifier = new natural.BayesClassifier(),
  					aspnetmvc_classifier = new natural.BayesClassifier(),
  					regex_classifier = new natural.BayesClassifier();

  					var taglist = [{"Tag" : "c#","Bayes" : csharp_classifier},
  					{"Tag" : "java","Bayes" : javajava_classifier},
  					{"Tag" : "php","Bayes" : php_classifier},
  					{"Tag" : "javascript","Bayes" : javascript_classifier},
  					{"Tag" : "android","Bayes" : android_classifier},
  					{"Tag" : "jquery","Bayes" : jquery_classifier},
  					{"Tag" : "c++","Bayes" : cplusplus_classifier},
  					{"Tag" : "python","Bayes" : python_classifier},
  					{"Tag" : "iphone","Bayes" : iphone_classifier},
  					{"Tag" : "asp.net","Bayes" : aspnet_classifier},
  					{"Tag" : "mysql","Bayes" : mysql_classifier},
  					{"Tag" : "html","Bayes" : html_classifier},
  					{"Tag" : ".net","Bayes" : net_classifier},
  					{"Tag" : "ios","Bayes" : ios_classifier},
  					{"Tag" : "objective-c","Bayes" : objectivec_classifier},
  					{"Tag" : "sql","Bayes" : sql_classifier},
  					{"Tag" : "css","Bayes" : css_classifier},
  					{"Tag" : "linux","Bayes" : linux_classifier},
  					{"Tag" : "ruby-on-rails","Bayes" : rubyonrails_classifier},
  					{"Tag" : "windows","Bayes" : windows_classifier},
  					{"Tag" : "c","Bayes" : c_classifier},
  					{"Tag" : "sql-server","Bayes" : sqlserver_classifier},
  					{"Tag" : "ruby","Bayes" : ruby_classifier},
  					{"Tag" : "wpf","Bayes" : wpf_classifier},
  					{"Tag" : "xml","Bayes" : xml_classifier},
  					{"Tag" : "ajax","Bayes" : ajax_classifier},
  					{"Tag" : "database","Bayes" : database_classifier},
  					{"Tag" : "windows-7","Bayes" : windows7_classifier},
  					{"Tag" : "asp.net-mvc","Bayes" : aspnetmvc_classifier},
  					{"Tag" : "regex", "Bayes" : regex_classifier}];
...
console.log("TEST1");
				...
				/*	});   */
			 	...
			 	function(taglist, callback) {   //TRAIN CLASSIFIERS FROM TRAINING DATA
					...
					/*		console.log("---------------------------------------------------------------------");
							...
							async.waterfall([   //time to do things one at a time
								...
								function(callback) {    				//PROCESS TEST DATA
									...
									for(var u = 0; u < taglist.length; u++){    

										if(training_tags.indexOf(taglist[u].Tag) === (-1) ){   

											taglist[u].Bayes.addDocument(train_text, taglist[u].Tag);		
											console.log("Training!");


											taglist[u].Bayes.train();

											if(u === 1)console.log(taglist[u].Bayes.classify("How can I create a loop that runs for, say, 10 iterations and sends messages forwards and backwards between process 1 and 3, going through process 2? Meaning, I would like process 1 to send a message to process 2, which should send it to process 3 and viceversa.</p> erlang distributed distributed-computing MonoDevelop HTML Tag Matching Error<p>I'm experiencing something really strange in MonoDevelop.  When writing standard HTML, Im getting weird Parser warnings telling me that my tags dont matc"));		
								...
								function(taglist,callback) {       //TEST AGAINST TRAINING TAGS
			 	...
			 	function(taglist,callback) {   //SAVE CLASSIFIERS

			 		//classifier.save('classifier.json', function(err, classifier) { });

			 		taglist[0].Bayes.save('../classifiers/csharp_classifier.json', function(err, classifier) { });
			 		taglist[1].Bayes.save('../classifiers/javajava_classifier.json', function(err, classifier) { });
			 		taglist[2].Bayes.save('../classifiers/php_classifier.json', function(err, classifier) { });
			 		taglist[3].Bayes.save('../classifiers/javascript_classifier.json', function(err, classifier) { });
			 		taglist[4].Bayes.save('../classifiers/android_classifier.json', function(err, classifier) { });
			 		taglist[5].Bayes.save('../classifiers/jquery_classifier.json', function(err, classifier) { });
			 		taglist[6].Bayes.save('../classifiers/cplusplus_classifier.json', function(err, classifier) { });
			 		taglist[7].Bayes.save('../classifiers/python_classifier.json', function(err, classifier) { });
			 		taglist[8].Bayes.save('../classifiers/iphone_classifier.json', function(err, classifier) { });
			 		taglist[9].Bayes.save('../classifiers/aspnet_classifier.json', function(err, classifier) { });
			 		taglist[10].Bayes.save('../classifiers/mysql_classifier.json', function(err, classifier) { });
			 		taglist[11].Bayes.save('../classifiers/html_classifier.json', function(err, classifier) { });
			 		taglist[12].Bayes.save('../classifiers/net_classifier.json', function(err, classifier) { });
			 		taglist[13].Bayes.save('../classifiers/ios_classifier.json', function(err, classifier) { });
			 		taglist[14].Bayes.save('../classifiers/objectivec_classifier.json', function(err, classifier) { });
			 		taglist[15].Bayes.save('../classifiers/sql_classifier.json', function(err, classifier) { });
			 		taglist[16].Bayes.save('../classifiers/css_classifier.json', function(err, classifier) { });
			 		taglist[17].Bayes.save('../classifiers/linux_classifier.json', function(err, classifier) { });
			 		taglist[18].Bayes.save('../classifiers/rubyonrails_classifier.json', function(err, classifier) { });
			 		taglist[19].Bayes.save('../classifiers/windows_classifier.json', function(err, classifier) { });
			 		taglist[20].Bayes.save('../classifiers/c_classifier.json', function(err, classifier) { });
			 		taglist[21].Bayes.save('../classifiers/sqlserver_classifier.json', function(err, classifier) { });
			 		taglist[22].Bayes.save('../classifiers/ruby_classifier.json', function(err, classifier) { });
			 		taglist[23].Bayes.save('../classifiers/wpf_classifier.json', function(err, classifier) { });
			 		taglist[24].Bayes.save('../classifiers/xml_classifier.json', function(err, classifier) { });
			 		taglist[25].Bayes.save('../classifiers/ajax_classifier.json', function(err, classifier) { });
			 		taglist[26].Bayes.save('../classifiers/database_classifier.json', function(err, classifier) { });
			 		taglist[27].Bayes.save('../classifiers/windows7_classifier.json', function(err, classifier) { });
			 		taglist[28].Bayes.save('../classifiers/aspnetmvc_classifier.json', function(err, classifier) { });
			 		taglist[29].Bayes.save('../classifiers/regex_classifier.json', function(err, classifier) { });   
						...
						//	console.log("BODY" + body);						
							...
							async.waterfall([   //time to do things one at a time
								...
								function(callback) {    				//PROCESS TEST DATA
									...
									console.log("TEST CLASSIFY: " + taglist[0].Bayes.getClassifications("fdafdasfdsagrwagf grawdg dwag awddfg adg javascript php"));
									...
									for(var u = 0; u < taglist.length; u++){    //FIND CANDIDATE TAGS IN TEST ROW
										...
										if(combined_text.indexOf(taglist[u].Tag) === (-1)){   //TEMPORARY STOP WORD FILTERS, REMOVE FROM DICTIONARY DB COLLECTION INSTEAD BEFORE PRODUCTION
											...
											var classify_out =  taglist[u].Bayes.getClassifications(combined_text);
											//console.log(classify_out);
											//glist[u].Score = classify_out[0].Value;

											if(classify_out !== undefined && classify_out[0] !== undefined && classify_out[0].value !== undefined && taglist[u].Score !== 0.12345){

												taglist[u].Score = classify_out[0].value;
												
												if(taglist[u].Score > 0.1){

													found_tags.push(taglist[u].Tag);
													console.log("-----------------------------");
													console.log("TAG: " + taglist[u].Tag);
													console.log("SCORE: " + taglist[u].Score);
													//console.log("TITLE: " + title);
													//console.log(  classify_out );
												}  
											}
								...
								function(found_tags, Id, callback) {       //TEST AGAINST TRAINING TAGS
									...
									stream.write(Id + ',"' + found_tags + '"' + '\n');  //***WRITE TO OUTPUT CSV FILE
                  					...
                  					console.log("TEST**************************" + Id + ',"' + found_tags + '"' + '\n'); 
