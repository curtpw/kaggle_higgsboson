		 ...
		 train_db.open(function(err, train_db) {
		 	...
		 	async.waterfall([   //time to do things one at a time
			 	...
			 	function(callback) {   //LOAD SIMPLE DICTIONARY INTO ARRAY
			 		...
			 		var taglist =["c#","php","java","android","javascript","jquery","python","c++","mysql","iphone","asp.net","html",".net","ios","objective-c","sql","css","linux","ruby-on-rails","c","windows","ruby","wpf","sql-server","asp.net-mvc","regex","ajax","xml","database","windows-7","django","facebook","eclipse","vb.net","xcode","osx","ubuntu","ruby-on-rails-3","json","networking","visual-studio-2010","git","bash","wordpress","winforms","asp.net-mvc-3","r","algorithm","multithreading","homework","string","actionscript-3","silverlight","html5","wcf","performance","visual-studio","security","perl","linq","apache","entity-framework","real-analysis","oracle","hibernate","web-services","calculus","spring","forms","cocoa",".htaccess","sql-server-2008","image","flex","ipad","flash","svn","apache2","query","cocoa-touch","probability","windows-phone-7","email","list","codeigniter","excel","swing","delphi","qt","google-app-engine","unit-testing","postgresql","scala","firefox","matlab","tsql","iis","node.js","command-line","magento","sqlite","debugging","google-chrome","powershell","api","http","jquery-ui","unix","google-maps","linear-algebra","windows-xp","vim","android-layout","mongodb","zend-framework","shell","facebook-graph-api","jsp","jsf","sharepoint","internet-explorer","sql-server-2005","ssh","templates","memory","nhibernate","centos","url","uitableview","audio","pdf","oop","c#-4.0","winapi","haskell","tomcat","gwt","dns","plugins","java-ee","sockets","authentication","rest","video","mvc","phonegap","blackberry","windows-8","ssl","cakephp","mod-rewrite","sorting","optimization","xslt","123ms-access","tikz-pgf","drupal","gui","windows-server-2008","visual-c++","design-patterns","maven","visual-studio-2008","emacs","algebra-precalculus","permissions","debian","listview","grails","iis7","xaml","mac","jquery-ajax","parsing","linq-to-sql","combinatorics","extjs","vba","abstract-algebra","complex-analysis","opencv","mobile","logging","css3","geometry","core-data","cookies","jquery-mobile","google-maps-api-3","ios5","pointers","nginx","image-processing","inheritance","statistics","object","variables","backbone.js","active-directory","opengl","macros","data-binding","reporting-services","web-applications","reflection","browser","servlets","group-theory","architecture","windows-vista","amazon-ec2","gcc","xpath","version-control","datetime","serialization","assembly","soap","crystal-reports","database-design","dom","memory-management","curl","hard-drive","heroku","sequences-and-series","functional-analysis","elementary-number-theory","gridview","animation","encryption","general-topology","batch","entity-framework-4","div","mercurial","differential-equations","ftp","jpa","python-3.x","filesystems","for-loop","joomla","razor","netbeans","javascript-events","mvvm","activerecord","number-theory","wireless-networking","iphone-sdk-4.0","asp-classic","unicode","twitter-bootstrap","iframe","ant","coldfusion","solr","actionscript","twitter","android-intent","silverlight-4.0","asp.net-mvc-2","matrices","microsoft-excel","file-upload","dojo","algebraic-geometry","opengl-es","ssis","open-source","jsf-2","clojure","jqgrid","amazon-web-services","dll","youtube","file-io","asynchronous","sharepoint2010","vpn","selenium","windows-server-2003","measure-theory","reference-request","virtualbox","symfony2","csv","virtualization","vbscript","svg","data-structures","android-widget","coding-style","oauth","drop-down-menu","combobox","asp.net-mvc-4","probability-theory","stored-procedures","spring-mvc","struts2","url-rewriting","knockout.js","frameworks","usb","excel-vba","vb6","msbuild","trigonometry","language-agnostic","jboss","awk","numpy","algebraic-topology","sdk","ruby-on-rails-3.1","azure","jdbc","lucene","jquery-plugins","cron","canvas","visual-studio-2012","custom-post-types","uitableviewcell","ldap","memory-leaks","playframework","elementary-set-theory","datagridview","batch-file","53f#","monotouch","android-listview","cygwin","android-emulator","uiview","hadoop","windows-server-2008-r2","gmail","ios6","commutative-algebra",".net-4.0"];
											...
											vectorcollection.update({ Term: a_tag },    //write to workhorse data science dictionary
												{	
													...
													function (err, document){
															...
															else{ console.log(a_tag); callback(); }
                ...
                async.waterfall([   //time to do things one at a time
			 		...
			 		function(callback) {   //LOAD SIMPLE DICTIONARY INTO ARRAY
		                ...
		                for (i in items) { //display as you go //DISPLAY LAST 5
		                	...
		                	if(items[i].docs.length > above_print){ top_tags.push(items[i]); console.log("Tag: " + items[i].Term + " #: " + items[i].docs.length);}
								//console.log('- - - - - - - - - - - - - - - -');
					...
					function(top_tags, callback) {       //PROCESS TEST DATA
						...
						for(var t = 0; t < top_tags.length; t++){             
					        ...
					        text_out = text_out + ' "" ' +  top_tags[t].Term + " , " + top_tags[t].docs.length;	
						}	

						fs.writeFile('../../Data/top_tag_list.txt', text_out, function(err) {
						    if(err) {
						        console.log(err);
						    } else {
