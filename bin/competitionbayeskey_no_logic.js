			 	...
			 	function(title_tag_classifier, body_tag_classifier, callback) {   //SAVE CLASSIFIERS
			 		...
			 		for(var v=0; v < add_keyword_search_list.length; v++){
			 			...
			 			if( tagstop(add_keyword_search_list[v]) === true  && stopword(add_keyword_search_list[v]) ===  false){
			 				...
			 				if(add_keyword_search_list[v].indexOf(".")  === true || add_keyword_search_list[v].indexOf("-")  === true){
					...
					var stream = fs.createWriteStream('../../Data/improved_superkeys_TESTvsTRAIN.csv', {flags: 'w'}); //create write stream and point towards output file
