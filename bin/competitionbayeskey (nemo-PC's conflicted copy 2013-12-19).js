			 	...
			 	function(title_tag_classifier, body_tag_classifier, callback) {   //SAVE CLASSIFIERS
			 		...
			 		for(var v=0; v < add_keyword_search_list.length; v++){
			 			...
			 			if( tagstop(add_keyword_search_list[v]) === true  && stopword(add_keyword_search_list[v]) ===  false){
			 				...
			 				if(add_keyword_search_list[v].indexOf(".")  === true || add_keyword_search_list[v].indexOf("-")  === true || add_keyword_search_list[v].indexOf("!")  === true || add_keyword_search_list[v].indexOf("$")  === true || add_keyword_search_list[v].indexOf("#")  === true || true add_keyword_search_list[v].indexOf("2") === true || add_keyword_search_list[v].indexOf("1") === true || add_keyword_search_list[v].indexOf("3") === true || add_keyword_search_list[v].indexOf("4") === true || add_keyword_search_list[v].indexOf("5") === true ||add_keyword_search_list[v].indexOf("6") === true || add_keyword_search_list[v].indexOf("7") === true || add_keyword_search_list[v].indexOf("8") === true || add_keyword_search_list[v].indexOf("9")){
					...
					var stream = fs.createWriteStream('../../Data/test_superkeys_out_lastbit_lastest2.csv', {flags: 'w'}); //create write stream and point towards output file
